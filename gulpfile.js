...
/**
 * Cleans the jor1k folder in the app directory
 * @return {Stream}
 */
gulp.task('clean-jor1k', function(done){
    log('Cleaning jor1k files from the app directory');
    clean(config.jor1kDest + '**', done);
});
/**
 * Copy the downloaded jor1k into app directory
 * @return {Stream}
 */
gulp.task('setupJor1k', ['clean-jor1k'], function(){
    log('Copying jor1k files into the app directory');
...
/**
 * Copy jor1k-sysroot to the app directory
 * @return {Stream}
 */
gulp.task('setupJor1kEfs', ['clean-jor1k'], function(){
